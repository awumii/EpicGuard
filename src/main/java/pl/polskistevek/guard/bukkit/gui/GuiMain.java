...
public class GuiMain {
    ...
    public static void show(Player p) {
        ...
        l2.add(ChatUtil.fix("&7Attack Protection: " + (AttackManager.attackMode ? "&aActive" : "&cInactive")));
        l2.add(ChatUtil.fix("&7Conn. Per Second: &c" + AttackManager.connectPerSecond));
        l2.add(ChatUtil.fix("&7Pings Per Second: &6" + AttackManager.pingPerSecond));
        l2.add(ChatUtil.fix("&7Joins Per Second: &e" + AttackManager.joinPerSecond));
        l2.add(ChatUtil.fix(""));
