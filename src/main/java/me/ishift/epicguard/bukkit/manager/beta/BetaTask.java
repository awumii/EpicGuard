...
public class BetaTask implements Runnable {
    ...
    public void run() {
        ...
        Notificator.action(MessagesBukkit.PREFIX + c + AttackManager.getConnectPerSecond() + "&7/" + c + "cps &8| " + p + AttackManager.getPingPerSecond() + "&7/" + p + "pps &8| &7Blocked: " + c + AttackManager.getTotalBots() + " &8| &7Duration: &e" + HeuristicsTask.getTime() + "sec");
    }
}
